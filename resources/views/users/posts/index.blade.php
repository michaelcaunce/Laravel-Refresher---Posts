...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-3">
      <h1 class="my-4 text-5xl font-bold leading-tight text-gray-600">{{ $user->name }}</h1>
    </div>
    <div class="flex flex-wrap -m-4 text-center">
      <div class="flex-1 p-4">
        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="text-secondary w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
